...
jobs:
  ...
  publish-containers:
    ...
    steps:
      ...
      # Build & Push ClickHouse Container
      - name: Build & Push ClickHouse Image
        uses: docker/build-push-action@v6
        with:
          context: ./infra
          ...
          push: true
          tags: |
            ${{ env.REGISTRY }}/${{ env.IMAGE_PREFIX }}/clickhouse:latest
            ${{ env.REGISTRY }}/${{ env.IMAGE_PREFIX }}/clickhouse:${{ github.sha }}
```
